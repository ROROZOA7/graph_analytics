...
from train_utils import train_skipgram, train_cbow
...
def main(args):
    ...
    # list all file in corpus_dir folder
    ...
    # embedding_fname = train_cbow(corpus_dir, wl_extn, learning_rate, embedding_size, num_negsample,
    #                                  epochs, batch_size, output_dir)
...
def parse_args():
    ...
    args.add_argument('-lr', "--learning_rate", default=0.1, type=float,
