...
def train_pvdm (corpus_dir, extn, learning_rate, embedding_size, num_negsample, epochs, batch_size, output_dir):
    '''
    ...
    final_embeddings = model_pvdm.train(corpus=corpus, batch_size=batch_size)
